...
<body>
    <div class="login-card"><img src="assets/img/avatar.png" class="profile-img-card">
        ...
        <form class="form-signin"  action="Registration" method="POST"><span class="reauth-email"> </span>
            ...
            <div class="checkbox">
                <input class="form-control" type="text" required="" placeholder="Company Name" name="companyName">
                <input class="form-control" type="hidden" required="" name="role" value="supplier">
                <div class="checkbox">
                    <label>
